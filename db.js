...
const migrations = [
  ...
  "ALTER TABLE community_posts ADD COLUMN fijado INTEGER NOT NULL DEFAULT 0",
  "ALTER TABLE client_accounts ADD COLUMN suspendido INTEGER NOT NULL DEFAULT 0",
  "ALTER TABLE users ADD COLUMN suspendido INTEGER NOT NULL DEFAULT 0",
  "ALTER TABLE community_reports ADD COLUMN estado TEXT NOT NULL DEFAULT 'pendiente'",
  "ALTER TABLE community_posts ADD COLUMN oculto INTEGER NOT NULL DEFAULT 0",
